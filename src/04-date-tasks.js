...
function angleBetweenClockHands(date) {
  const hourHand = (date.getUTCHours() > 12) ? (date.getUTCHours() - 12) : date.getUTCHours();
  const minuteHand = date.getUTCMinutes();
  let angle = Math.abs(0.5 * (60 * hourHand - 11 * minuteHand));
